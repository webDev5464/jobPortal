...
const Jobslisting = () => {
  ...
  const [loctiondrop, setLoctionlDrop] = useState(true);
  const [dateposteddrop, setDatePostedDrop] = useState(true);
  const [jobtypedrop, setJobTypeDrop] = useState(true);
  const [sectordrop, setSectorDrop] = useState(true);
        ...
        <div className="grid grid-cols-2   ">
          <div className="m-auto text-start pr-24 ">
              ...
              <div className="shadow w-60">
                <div className="text-white bg-primary flex items-center justify-center p-2">
                  <button
                    ...
                    onClick={() => setEmailDrop(!emaildrop)}
                  >
            ...
            <div className="pb-2">
              <div className="shadow  w-60">
                <div
                  className="w-58 cursor-pointer text-slate-500 font-bold bg-white flex items-center justify-between  px-4 p-2"
                  onClick={() => setLoctionlDrop(!loctiondrop)}
                >
                  Locations
                  <NavLink>
            ...
            <div className="pb-2">
              <div className="shadow  w-60">
                <div
                  className="w-58 text-slate-500 cursor-pointer font-bold bg-white flex items-center justify-between px-4 p-2"
                  onClick={() => setDatePostedDrop(!dateposteddrop)}
                >
                  Date Posted
                  <NavLink>
                    <IoIosArrowDown className="text-black" />
            ...
            <div className="pb-2">
              <div className="py-2 shadow  w-60">
                <div
                  className="w-58 text-slate-500 cursor-pointer font-bold bg-white flex items-center justify-between  px-4 p-2"
                  onClick={() => setJobTypeDrop(!jobtypedrop)}
                >
                  Job Type
                  <NavLink>
                    <IoIosArrowDown className="text-black" />
            ...
            <div className="pb-2">
              <div className="py-2 shadow  w-60">
                <div
                  className="w-58 text-slate-500 cursor-pointer font-bold  bg-white flex items-center justify-between px-4 p-2"
                  onClick={() => setSectorDrop(!sectordrop)}
                >
                  Sector
                  <NavLink>
                    <IoIosArrowDown className="text-black" />
